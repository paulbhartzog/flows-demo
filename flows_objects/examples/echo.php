...
if($_GET) {
	...
	if (array_key_exists("sip", $incoming_array)){
		...
		$xml_output .= "\t</response_types>\n";
		$xml_output .= "\t<usage>
		This Flows component accepts GET requests and returns whatever data the component received with the request.
	</usage>\n";
	$xml_output  .=  "</xml>\n";
	echo $xml_output;
	} else {
